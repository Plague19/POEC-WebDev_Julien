...
if( ! function_exists( 'relic_fashion_store_single_category_and_products_section' ) ) {
    function relic_fashion_store_single_category_and_products_section(){
        ...
        $relic_fashion_store_products_single_category_and_products_count = intval( get_theme_mod( 'relic_fashion_store_products_single_category_and_products_count',3 ) );
